...
public class xiazai {
    ...
    public ResponseEntity<byte[]> testResponseEntity(HttpSession session) throws IOException {
        ...
        realPath = realPath + File.separator + "VC.jpg";
        //创建输入流
        ...
        //设置要下载方式以及下载文件的名字
        headers.add("Content-Disposition", "attachment;filename=VC.jpg");
        //设置响应状态码
...
//        String photoPath = servletContext.getContextPath();
      ...
      String finalPath = photoPath + File.separator + fileName;
        //上传文件
        photo.transferTo(new File(photoPath,fileName));
        model.addAttribute("cc","img/"+fileName);
        return "shangchuan";
    }
}
